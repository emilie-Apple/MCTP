<div class="modal2">
    ...
    <div class="modal-strip">
        <img src="./assets/img/carrelage1.jpg">
    </div>
    <div class="modal-strip">
        <img src="./assets/img/sdb1.jpg">
    </div>
    <div class="modal-strip">
    ...
    <div class='modal_content'>
        ...
        <p>Vous pouvez consulter nos oeuvres déjà terminées, en passant par ce bouton : <a class="modal_button" href="#t4"><i class="fa fa-gavel" aria-hidden="true"></i>&nbsp;Nos réalisations</button></a>
</p>
    </div>
