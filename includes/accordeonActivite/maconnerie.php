<div class="modal1">
    ...
    <div class="modal-strip">
        <img src="./assets/img/maconnerie1.jpg">
    </div>
    <div class="modal-strip">
        <img src="./assets/img/maconnerie2.jpg">
    </div>
    <div class="modal-strip">
        <img src="./assets/img/maconnerie3.jpg">
    </div>
    <div class='modal-content'>
        <p>Spécialiste de la maçonnerie traditionnelle et de la couverture,
